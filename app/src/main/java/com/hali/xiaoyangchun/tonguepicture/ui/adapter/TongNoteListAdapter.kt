...
class TongNoteListAdapter(private var context: Context, private var mData: MutableList<User>? = null) : RecyclerView.Adapter<TongNoteListAdapter.NodeHolder>(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NodeHolder {
        var view = LayoutInflater.from(context).inflate(R.layout.item_list_node, parent, false)
    ...
    override fun onClick(v: View) {
        itemClickListener?.onItemClick(v, v.tag as User)
    }
